...
fn aero_button_up_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// outer border
...
fn aero_button_up_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	if w >= h {
		// top gradient
		vertical_gradient(x+2, y+2, x+w-3, y+h/2-1, activated_color(Color::from_rgb(0xF1, 0xF1, 0xF1)),
			activated_color(Color::from_rgb(0xEA, 0xEA, 0xEA)));
		// bottom gradient
		vertical_gradient(x+2, y+h/2, x+w-3, y+h-3, activated_color(Color::from_rgb(0xDC, 0xDC, 0xDC)),
			activated_color(Color::from_rgb(0xCE, 0xCE, 0xCE)));
	}
	else {
		// left gradient
		horizontal_gradient(x+2, y+2, x+w/2-1, y+h-3, activated_color(Color::from_rgb(0xF1, 0xF1, 0xF1)),
			activated_color(Color::from_rgb(0xEA, 0xEA, 0xEA)));
		// right gradient
		horizontal_gradient(x+w/2, y+2, x+w-3, y+h-3, activated_color(Color::from_rgb(0xDC, 0xDC, 0xDC)),
			activated_color(Color::from_rgb(0xCE, 0xCE, 0xCE)));
	}
	aero_button_up_frame(x, y, w, h, c);
}

fn aero_check_down_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// outer border
...
fn aero_panel_thin_up_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	set_draw_color(activated_color(c));
	draw_rectf(x+1, y+1, w-2, h-2);
	aero_panel_thin_up_frame(x, y, w, h, c);
}

fn aero_spacer_thin_down_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// top and left borders
	set_draw_color(activated_color(Color::from_rgb(0xC9, 0xC9, 0xC9)));
	draw_yxline2(x, y+h-2, y, x+w-2);
	// bottom and right borders
...
fn aero_spacer_thin_down_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	set_draw_color(activated_color(c));
	draw_rectf(x+1, y+1, w-2, h-2);
	aero_spacer_thin_down_frame(x, y, w, h, c);
}

fn aero_radio_round_down_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// middle border
	set_draw_color(activated_color(Color::from_rgb(0xF4, 0xF4, 0xF4)));
...
fn aero_radio_round_down_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	set_draw_color(activated_color(Color::from_rgb(0xF5, 0xF5, 0xF5)));
	draw_pie(x+2, y+2, w-4, h-4, 0.0, 360.0);
	aero_radio_round_down_frame(x, y, w, h, c);
}

fn aero_hovered_up_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// outer border
...
fn aero_hovered_up_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// top gradient
	vertical_gradient(x+2, y+2, x+w-3, y+h/2-1, activated_color(Color::from_rgb(0xE9, 0xF5, 0xFC)),
		activated_color(Color::from_rgb(0xD8, 0xEF, 0xFB)));
	// bottom gradient
	vertical_gradient(x+2, y+h/2, x+w-3, y+h-3, activated_color(Color::from_rgb(0xBD, 0xE5, 0xFC)),
		activated_color(Color::from_rgb(0xA7, 0xD8, 0xF4)));
	aero_hovered_up_frame(x, y, w, h, c);
}

fn aero_depressed_down_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// outer border
...
fn aero_depressed_down_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// top gradient
	vertical_gradient(x+2, y+2, x+w-3, y+h/2-1, activated_color(Color::from_rgb(0xE4, 0xF3, 0xFB)),
		activated_color(Color::from_rgb(0xC4, 0xE5, 0xF6)));
	// bottom gradient
	vertical_gradient(x+2, y+h/2, x+w-3, y+h-2, activated_color(Color::from_rgb(0x98, 0xD1, 0xEF)),
		activated_color(Color::from_rgb(0x68, 0xB3, 0xDB)));
	aero_depressed_down_frame(x, y, w, h, c);
}

fn aero_input_thin_down_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// top border
...
fn aero_input_thin_down_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	set_draw_color(activated_color(c));
	draw_rectf(x+1, y+1, w-2, h-2);
	aero_input_thin_down_frame(x, y, w, h, c);
}

fn aero_default_button_up_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// outer border
...
fn aero_default_button_up_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// top gradient
	vertical_gradient(x+3, y+3, x+w-4, y+h/2-1, activated_color(Color::from_rgb(0xF0, 0xF3, 0xF5)),
		activated_color(Color::from_rgb(0xE9, 0xEE, 0xF1)));
	// bottom gradient
	vertical_gradient(x+3, y+h/2, x+w-4, y+h-4, activated_color(Color::from_rgb(0xD7, 0xE1, 0xE7)),
		activated_color(Color::from_rgb(0xC8, 0xD5, 0xDD)));
	aero_default_button_up_frame(x, y, w, h, c);
}

fn aero_default_hovered_up_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// top gradient
	vertical_gradient(x+2, y+2, x+w-3, y+h/2-1, activated_color(Color::from_rgb(0xE9, 0xF5, 0xFC)),
		activated_color(Color::from_rgb(0xD8, 0xEF, 0xFB)));
	// bottom gradient
...
fn aero_tabs_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
	set_draw_color(activated_color(Color::from_rgb(0x88, 0x8B, 0x94)));
	draw_rect(x, y, w, h);
}

fn aero_tabs_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	set_draw_color(activated_color(c));
	draw_rectf(x+1, y+1, w-2, h-2);
	aero_tabs_frame(x, y, w, h, c);
}

fn aero_swatch_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// outer border
...
fn aero_swatch_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	set_draw_color(activated_color(c));
...
fn use_aero_scheme() {
	...
	app::set_frame_type_cb(OS_SPACER_THIN_DOWN_BOX, aero_spacer_thin_down_box, 1, 1, 2, 2);
	app::set_frame_type_cb(OS_PANEL_THIN_UP_FRAME, aero_panel_thin_up_frame, 1, 1, 2, 2);
	app::set_frame_type_cb(OS_SPACER_THIN_DOWN_FRAME, aero_spacer_thin_down_frame, 1, 1, 2, 2);
	app::set_frame_type_cb(OS_RADIO_ROUND_DOWN_BOX, aero_radio_round_down_box, 3, 3, 6, 6);
	...
	app::set_frame_type_cb(OS_DEPRESSED_DOWN_FRAME, aero_depressed_down_frame, 2, 2, 4, 4);
	app::set_frame_type_cb(OS_INPUT_THIN_DOWN_BOX, aero_input_thin_down_box, 1, 2, 2, 4);
	app::set_frame_type_cb(OS_INPUT_THIN_DOWN_FRAME, aero_input_thin_down_frame, 1, 2, 2, 4);
	app::set_frame_type_cb(OS_DEFAULT_BUTTON_UP_BOX, aero_default_button_up_box, 2, 2, 4, 4);
	app::set_frame_type_cb(OS_DEFAULT_HOVERED_UP_BOX, aero_default_hovered_up_box, 2, 2, 4, 4);
