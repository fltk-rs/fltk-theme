...
fn aqua2_button_up_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
    if w >= h {
        // top gradient
        vertical_gradient(
            x + 2,
    ...
    aqua2_button_up_frame(x, y, w, h, c);
}

fn aqua2_panel_thin_up_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
    set_draw_color(activated_color(devalued(c, 0.06751)));
    draw_rect(x, y, w, h);
}

fn aqua2_panel_thin_up_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
    set_draw_color(activated_color(c));
    draw_rectf(x + 1, y + 1, w - 2, h - 2);
    aqua2_panel_thin_up_frame(x, y, w, h, c);
}

fn aqua2_spacer_thin_down_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
...
fn aqua2_spacer_thin_down_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
    set_draw_color(activated_color(c));
    draw_rectf(x + 1, y + 1, w - 2, h - 2);
    aqua2_spacer_thin_down_frame(x, y, w, h, c);
}

fn aqua2_radio_round_down_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
    set_draw_color(activated_color(devalued(c, 0.42194)));
    draw_arc(x, y, w, h, 0.0, 360.0);
}

fn aqua2_radio_round_down_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
    // top edges
    ...
    set_draw_color(activated_color(Color::from_rgb(0xEF, 0xEE, 0xEC)));
    draw_xyline(x + 2, y + h - 3, x + w - 3);
    aqua2_radio_round_down_frame(x, y, w, h, c);
}

fn aqua2_depressed_down_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
    // top outer border
...
fn aqua2_depressed_down_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
    // top gradient
    vertical_gradient(
        x + 2,
        y + 2,
    ...
    aqua2_depressed_down_frame(x, y, w, h, c);
}

fn aqua2_input_thin_down_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
    // top outer border
...
fn aqua2_input_thin_down_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
    set_draw_color(activated_color(Color::from_rgb(0xFF, 0xFF, 0xFF)));
    draw_rectf(x + 2, y + 3, w - 4, h - 4);
    aqua2_input_thin_down_frame(x, y, w, h, c);
}

fn aqua2_default_button_up_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
    // top outer border
...
fn aqua2_default_button_up_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
    // top gradient
    vertical_gradient(
        x + 2,
        y + 2,
    ...
    aqua2_default_button_up_frame(x, y, w, h, c);
}

fn aqua2_tabs_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
    // top outer border
...
fn aqua2_tabs_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
    set_draw_color(activated_color(c));
    draw_rectf(x + 2, y + 2, w - 4, h - 4);
    aqua2_tabs_frame(x, y, w, h, c);
}

fn aqua2_swatch_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
    // outer border
...
fn aqua2_swatch_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
    set_draw_color(activated_color(c));
    draw_rectf(x + 2, y + 2, w - 4, h - 4);
    aqua2_swatch_frame(x, y, w, h, c);
}

fn use_aqua2_scheme() {
    app::set_scheme(app::Scheme::Gtk);
    app::set_frame_type_cb(OS_BUTTON_UP_BOX, aqua2_button_up_box, 1, 1, 2, 2);
    app::set_frame_type2(OS_CHECK_DOWN_BOX, OS_BUTTON_UP_BOX);
    app::set_frame_type_cb(OS_BUTTON_UP_FRAME, aqua2_button_up_frame, 1, 1, 2, 2);
    app::set_frame_type2(OS_CHECK_DOWN_FRAME, OS_BUTTON_UP_FRAME);
    app::set_frame_type_cb(OS_PANEL_THIN_UP_BOX, aqua2_panel_thin_up_box, 1, 1, 2, 2);
    app::set_frame_type_cb(
        OS_SPACER_THIN_DOWN_BOX,
        aqua2_spacer_thin_down_box,
        1,
        1,
        2,
        2,
    );
    app::set_frame_type_cb(OS_PANEL_THIN_UP_FRAME, aqua2_panel_thin_up_frame, 1, 1, 2, 2);
    app::set_frame_type_cb(
        OS_SPACER_THIN_DOWN_FRAME,
        aqua2_spacer_thin_down_frame,
        1,
        1,
        2,
        2,
    ...
    app::set_frame_type_cb(OS_DEPRESSED_DOWN_BOX, aqua2_depressed_down_box, 1, 1, 2, 2);
    ...
    app::set_frame_type_cb(OS_INPUT_THIN_DOWN_BOX, aqua2_input_thin_down_box, 2, 3, 4, 6);
    app::set_frame_type_cb(
        OS_INPUT_THIN_DOWN_FRAME,
        aqua2_input_thin_down_frame,
        2,
        3,
        4,
        6,
    ...
    app::set_frame_type_cb(OS_TABS_BOX, aqua2_tabs_box, 2, 1, 4, 2);
    app::set_frame_type_cb(OS_SWATCH_BOX, aqua2_swatch_box, 2, 2, 4, 4);
