...
fn aqua_button_up_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	if w >= h {
		// top gradient
		vertical_gradient(x+2, y+2, x+w-3, y+h/2-1, Color::from_rgb(0xFF, 0xFF, 0xFF), Color::from_rgb(0xF6, 0xF5, 0xF4));
		// bottom fill
		...
		// left gradient
		horizontal_gradient(x+2, y+2, x+w/2-1, y+h-3, Color::from_rgb(0xFF, 0xFF, 0xFF), Color::from_rgb(0xF6, 0xF5, 0xF4));
		// right fill
		set_draw_color(activated_color(Color::from_rgb(0xED, 0xEC, 0xEA)));
...
fn aqua_depressed_down_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// top gradient
	vertical_gradient(x+2, y+2, x+w-3, y+h/2-1, Color::from_rgb(0xA3, 0xC1, 0xEF), Color::from_rgb(0x67, 0xA1, 0xE9));
	// bottom gradient
	vertical_gradient(x+2, y+h/2, x+w-3, y+h-2, Color::from_rgb(0x46, 0x93, 0xE9), Color::from_rgb(0xAA, 0xD4, 0xF0));
...
fn aqua_default_button_up_box(x: i32, y: i32, w: i32, h: i32, c: Color) {
	// top gradient
	vertical_gradient(x+2, y+2, x+w-3, y+h/2-1, Color::from_rgb(0xBF, 0xDC, 0xF7), Color::from_rgb(0x84, 0xC4, 0xF1));
	// bottom gradient
	vertical_gradient(x+2, y+h/2, x+w-3, y+h-2, Color::from_rgb(0x59, 0xB5, 0xF1), Color::from_rgb(0xBA, 0xE9, 0xF7));
...
fn use_aqua_scheme() {
	...
	app::set_frame_type_cb(OS_SPACER_THIN_DOWN_BOX, aqua_spacer_thin_down_box, 1, 1, 2, 2);
	app::set_frame_type_cb(OS_PANEL_THIN_UP_FRAME, aqua_panel_thin_up_frame, 1, 1, 2, 2);
	app::set_frame_type_cb(OS_SPACER_THIN_DOWN_FRAME, aqua_spacer_thin_down_frame, 1, 1, 2, 2);
	app::set_frame_type_cb(OS_RADIO_ROUND_DOWN_BOX, aqua_radio_round_down_box, 2, 2, 4, 4);
	...
	app::set_frame_type_cb(OS_DEPRESSED_DOWN_FRAME, aqua_depressed_down_frame, 1, 1, 2, 2);
	app::set_frame_type_cb(OS_INPUT_THIN_DOWN_BOX, aqua_input_thin_down_box, 2, 3, 4, 6);
	app::set_frame_type_cb(OS_INPUT_THIN_DOWN_FRAME, aqua_input_thin_down_frame, 2, 3, 4, 6);
	app::set_frame_type_cb(OS_DEFAULT_BUTTON_UP_BOX, aqua_default_button_up_box, 1, 1, 2, 2);
