...
fn classic_radio_round_down_frame(x: i32, y: i32, w: i32, h: i32, c: Color) {
	...
	set_draw_color(activated_color(Color::gray_ramp('A' as i32 -'A' as i32)));
...
fn use_classic_scheme() {
	...
	app::set_frame_type_cb(OS_SPACER_THIN_DOWN_BOX, classic_spacer_thin_down_box, 1, 1, 2, 2);
	app::set_frame_type_cb(OS_PANEL_THIN_UP_FRAME, classic_panel_thin_up_frame, 1, 1, 2, 2);
	app::set_frame_type_cb(OS_SPACER_THIN_DOWN_FRAME, classic_spacer_thin_down_frame, 1, 1, 2, 2);
	app::set_frame_type_cb(OS_RADIO_ROUND_DOWN_BOX, classic_radio_round_down_box, 2, 2, 4, 4);
	...
	app::set_frame_type_cb(OS_DEPRESSED_DOWN_FRAME, classic_check_down_frame, 2, 2, 4, 4);
	app::set_frame_type_cb(OS_INPUT_THIN_DOWN_BOX, classic_check_down_box, 2, 3, 4, 6);
	app::set_frame_type_cb(OS_INPUT_THIN_DOWN_FRAME, classic_check_down_frame, 2, 3, 4, 6);
	app::set_frame_type_cb(OS_DEFAULT_BUTTON_UP_BOX, classic_default_button_up_box, 3, 3, 6, 6);
	app::set_frame_type_cb(OS_DEFAULT_HOVERED_UP_BOX, classic_default_button_up_box, 3, 3, 6, 6);
	app::set_frame_type_cb(OS_DEFAULT_DEPRESSED_DOWN_BOX, classic_check_down_box, 2, 2, 4, 4);
	...
	app::set_frame_type_cb(OS_MINI_DEPRESSED_DOWN_BOX, classic_check_down_box, 2, 2, 4, 4);
	app::set_frame_type_cb(OS_MINI_BUTTON_UP_FRAME, classic_button_up_frame, 2, 2, 4, 4);
	app::set_frame_type_cb(OS_MINI_DEPRESSED_DOWN_FRAME, classic_check_down_frame, 2, 2, 4, 4);
	...
	app::set_frame_type_cb(FrameType::RoundDownBox, classic_radio_round_down_box, 2, 2, 4, 4);
